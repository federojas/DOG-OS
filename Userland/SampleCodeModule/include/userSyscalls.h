...
SYS_SEM_POST_ID, SYS_SEM_WAIT_ID, SYS_SEM_CLOSE_ID, SYS_SEM_STATUS_ID, SYS_SEC_ELAPSED_ID,
SYS_PIPE_STATUS_ID, SYS_PIPE_OPEN_ID, SYS_PIPE_CLOSE_ID, SYS_PIPE_WRITE_ID,
SYS_PIPE_READ_ID, SYS_WAIT_ID} t_syscall_id;
