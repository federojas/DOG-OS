...
static int getCPUFeaturesWrapper(uint64_t rsi, uint64_t rdx, uint64_t rcx,
                                 uint64_t r8, uint64_t r9) {
...
static int checkCPUIDWrapper(uint64_t rsi, uint64_t rdx, uint64_t rcx,
                             uint64_t r8, uint64_t r9) {
  return _checkCPUID();
}
...
static int getCPUVendorWrapper(uint64_t rsi, uint64_t rdx, uint64_t rcx,
                               uint64_t r8, uint64_t r9) {
...
static int getHalfScreenSizeWrapper(uint64_t rsi, uint64_t rdx, uint64_t rcx,
                                    uint64_t r8, uint64_t r9) {
  return halfScreenCharSize();
}

static functionPointer syscall[] = {getCurrentTimeWrapper,
